    ...
    a.JQPlugin.createPlugin({
                ...
                if (c.options.serverSync) {
                    ...
                    if (b._eqNull(d[2])) {
                        var f = a.isFunction(c.options.serverSync)
                            ...
                            : null;
                        d[2] =
                            (f ? new Date().getTime() - f.getTime() : 0) - d[1];
                    }
                    c._since &&
                        c._since.setMilliseconds(
                            c._since.getMilliseconds() + d[2]
                        ),
            ...
            if (((b = b.jquery ? b : a(b)), (c = c || this._getInst(b)))) {
                if (
                    ...
                    (1 !== c.options.tickInterval &&
                        this.periodsToSeconds(d) % c.options.tickInterval !==
                            0) ||
        ...
        _adjustSettings: function (b, c, d) {
            ...
            (j = this._eqNull(j) ? -g.getTimezoneOffset() : j),
                (d ||
                    (!d && this._eqNull(c._until) && this._eqNull(c._since))) &&
                    ...
                    this._eqNull(c._since) ||
                        ...
                        c._since &&
                            h &&
                            c._since.setMilliseconds(
                                c._since.getMilliseconds() + h
                            )),
                    (c._until = this.UTCDate(
                        j,
                        this._determineTime(c.options.until, g)
                    )),
                    h &&
                        c._until.setMilliseconds(
                            c._until.getMilliseconds() + h
                        )),
        ...
        _generateHTML: function (b) {
            ...
            var q = b.options.compact
                ...
                s = function (a) {
                    ...
                    return n[a]
                        ? j._translateDigits(b, b._periods[a]) +
                              (c ? c[a] : q[a]) +
                              " "
                        : "";
                },
