...
(window.Modernizr = (function (a, b, c) {
    ...
    var j,
        ...
        B = {}.hasOwnProperty;
    (l =
        e(B, "undefined") || e(B.call, "undefined")
            ? function (a, b) {
    ...
    (function (a) {
        "function" == typeof define && define.amd
            ...
            ? (module.exports = a(window.jQuery, window.Modernizr))
        ...
        return (
            ...
            (C.prototype._doesPassFilter = function (b, c) {
                ...
                var d = c.data(w),
                    e =
                        this.delimeter && !a.isArray(d)
                            ? d.split(this.delimeter)
                            : d;
                return a.inArray(b, e) > -1;
            }),
            (C.prototype._toggleFilterClasses = function (a, b) {
                a
                    .removeClass(C.ClassName.CONCEALED)
                    .addClass(C.ClassName.FILTERED),
                    b
                        .removeClass(C.ClassName.FILTERED)
                        .addClass(C.ClassName.CONCEALED);
            }),
            (C.prototype._initItems = function (a) {
                (a = a || this.$items),
                    a.addClass(
                        [C.ClassName.SHUFFLE_ITEM, C.ClassName.FILTERED].join(
                            " "
                        )
                    ),
                ...
                f(
                    ...
                    c.length > 0 && this.initialized
                        ? ((this.isTransitioning = !0),
                          this.supported
                              ? this._whenCollectionDone(
                                    c,
                                    o,
                                    this._movementFinished
                                )
                              : this._whenAnimationsDone(
                                    this._movementFinished
                                ))
